...
def construct_model(inputs_shape, filters_shape, conv_layer_class):
...
def setup_training(inputs_shape, filters_shape, conv_layer_class):
    ...
    mlp = construct_model(inputs_shape, filters_shape, conv_layer_class)
...
def expect_results(inputs_shape, filters_shape, conv_layer_class, 
    expected_results):
    mlp_fprop, train_set, valid_set, test_set, algorithm = setup_training(
        inputs_shape, filters_shape, conv_layer_class)
...
def test_training():
    ...
    expect_results(inputs_shape, filters_shape, Theano3dConv3dElemwise,
        {'train': [0.3, 0.98, 1.0, 1.0, 1.0],
         'valid': [0.4, 0.92, 1.0, 1.0, 1.0],
         'test': [0.32, 0.84, 0.88, 0.92, 0.92],
       })
    expect_results(inputs_shape, filters_shape, Theano3d2dConv3dElemwise,
